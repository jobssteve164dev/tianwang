...
class MixedDetectionAccuracyTest:
    ...
    def __init__(self):
        ...
        self.test_cases: List[DetectionCase] = []
    ...
    def generate_test_cases(self, num_cases_per_type: int = 100) -> List[DetectionCase]:
        """生成测试用例"""
        test_cases = []
        case_counter = 0
    ...
    async def run_accuracy_test(self, test_cases: List[DetectionCase]) -> List[DetectionResult]:
        """运行准确性测试"""
    ...
    def calculate_accuracy_metrics(self, test_cases: List[DetectionCase], results: List[DetectionResult]) -> AccuracyMetrics:
        """计算准确性指标"""
    ...
    def analyze_threat_type_performance(self, test_cases: List[DetectionCase], results: List[DetectionResult]) -> Dict[str, Dict[str, Any]]:
        """分析各威胁类型的检测性能"""
